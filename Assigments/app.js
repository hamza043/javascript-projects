...
const fruitsListElement = document.getElementById("fruitsList");

let fruitsHTML = "";
for (let i = 0; i < fruits.length; i++) {
    fruitsHTML =`<p>${fruits[i]}</p>`;
  fruitsHTML += `<p>Element of index ${i} is ${fruits[i]}</p>`;
}

fruitsListElement.innerHTML = fruitsHTML;